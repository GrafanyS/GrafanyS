...
Меня зовут Андрей, мне 53 лет.

:computer: Я давно работаю в ИТ, :mag: начиная с 2022 года я решил сменить направление и перейти в разработчик полного стека, в большенстве изучал информацию самостоятельно, на основе курсов в сети Интеренет :clapper:. Прошел стартовые курсы по Фронтенд разработке и программировании на языке **Python**. На различных платформах, таких как Stepik.

:key: Для улучшения навыков и получения опыта и нового диплома поступил в онлайн университет GeekBrains на **разработчик полного стека**, где продолжаю улучшать свои навыки.
